...
Due to what appears to have been a limitation of font technology in the days of typewriters, metal typography, and early digital typography, unseated [hamzao]{.trn} between two joining letters [ـءـ]{.ar} was usually written as seated on [yAE]{.trn} instead: [ـئـ]{.ar}. Because of this limitation we are now accustomed to seeing:
