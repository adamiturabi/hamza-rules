...
In order to determine the seat of hamza for a words, we must first separate the main word from any prefixes and suffixes.
We will determine the seat of hamza for the main word first.
Hamza can occur in three positions in the main word:
...
**Main rule:** Consider the vowel on the consonant before the hamza and the _shortened_ vowel on the hamza itself. Determine which of the two vowels is higher in precedence in the above table. The prevailing vowel's seat will be the seat of the hamza.
...
+ [هَيْءَة]{.ar} [hayEao]{.trn}  
  Vowel on consonant before hamza: [ay]{.trn}  
  Shortened vowel on hamza: [a]{.trn}  
  Precedence: [ay]{.trn}  
  Seated:[ء]{.ar} 

+ [خَطِيءَة]{.ar} [xaTIEao]{.trn}  
  Vowel on consonant before hamza: [I]{.trn}  
  Shortened vowel on hamza: [a]{.trn}  
  Precedence: [I]{.trn}  
  Seated:[ء]{.ar} 

+ [اسْتِيءَاس]{.ar} [EistIEAs]{.trn}
  Vowel on consonant before hamza: [I]{.trn}  
  Shortened vowel on hamza: [a]{.trn}  
  Precedence: [I]{.trn}  
  Seated:[ء]{.ar} (Exception: [ءَا]{.ar} is not written as [آ]{.ar} when the preceding vowel is [I]{.trn}.)

+ [تَوْءَم]{.ar} [tawEam]{.trn}
  Vowel on consonant before hamza: [aw]{.trn}  
  Shortened vowel on hamza: [a]{.trn}  
  Precedence: [aw]{.trn}  
  Seated:[ء]{.ar} 

+ [سَائِل]{.ar} [sAEil]{.trn}
  Vowel on consonant before hamza: [A]{.trn}  
  Shortened vowel on hamza: [i]{.trn}  
  Precedence: [i]{.trn}  
  Seated: [ئ]{.ar}

+ [تَسَاؤُل]{.ar} [tasAEul]{.trn}
  Vowel on consonant before hamza: [A]{.trn}  
  Shortened vowel on hamza: [u]{.trn}  
  Precedence: [u]{.trn}  
  Seated:[ؤ]{.ar} 

+ [تَسَاءَلَ]{.ar} [tasAEala]{.trn}
  Vowel on consonant before hamza: [A]{.trn}  
  Shortened vowel on hamza: [a]{.trn}  
  Precedence: [A]{.trn}  
  Seated:[ء]{.ar} 

+ [قِرَاءَات]{.ar} [qirAEAt]{.trn}
  Vowel on consonant before hamza: [A]{.trn}  
  Shortened vowel on hamza: [a]{.trn}  
  Precedence: [A]{.trn}  
  Seated:[ء]{.ar} 

+ [مَسْؤُول]{.ar} [masEUl]{.trn}
  Vowel on consonant before hamza: [◌ْ]{.ar}  
  Shortened vowel on hamza: [u]{.trn}  
  Precedence: [u]{.trn}  
  Seated:[ؤ]{.ar} 

+ [تَرْئِيس]{.ar} [tarEIs]{.trn}
  Vowel on consonant before hamza: [◌ْ]{.ar}  
  Shortened vowel on hamza: [i]{.trn}  
  Precedence: [i]{.trn}  
  Seated:[ئ]{.ar} 

+ [مِرْآة]{.ar} [mirEAo]{.trn}  
  Vowel on consonant before hamza: [◌ْ]{.ar}  
  Shortened vowel on hamza: [a]{.trn}  
  Precedence: [a]{.trn}  
  Seated:[ء]{.ar} (Using sub-rule.)

+ [ظَمْآن]{.ar} [PamEAn]{.trn}  
  Vowel on consonant before hamza: [◌ْ]{.ar}  
  Shortened vowel on hamza: [a]{.trn}  
  Precedence: [a]{.trn}  
  Seated:[ء]{.ar} (Using sub-rule.)

+ [مَسْأَلَة]{.ar} [masEalao]{.trn}  
  Vowel on consonant before hamza: [◌ْ]{.ar}  
  Shortened vowel on hamza: [a]{.trn}  
  Precedence: [a]{.trn}  
  Seated:[أ]{.ar}

+ [الْمَرْأَة]{.ar} [almarEao]{.trn}  
  Vowel on consonant before hamza: [◌ْ]{.ar}  
  Shortened vowel on hamza: [a]{.trn}  
  Precedence: [a]{.trn}  
  Seated:[أ]{.ar}
...
+ [بِئْسَ]{.ar} [biEsa]{.trn}  
  Vowel on consonant before hamza: [i]{.trn}  
  Shortened vowel on hamza: [◌ْ]{.ar}  
  Precedence: [i]{.trn}  
  Seated:[ئ]{.ar}

+ [سُؤْلَكَ]{.ar} [suElaka]{.trn}  
  Vowel on consonant before hamza: [u]{.trn}  
  Shortened vowel on hamza: [◌ْ]{.ar}  
  Precedence: [u]{.trn}  
  Seated:[ؤ]{.ar}
...
+ [سُئِلَ]{.ar} [suEila]{.trn}  
  Vowel on consonant before hamza: [u]{.trn}  
  Shortened vowel on hamza: [i]{.trn}  
  Precedence: [a]{.trn}  
  Seated:[أ]{.ar}

+ [يَئِسَ]{.ar} [yaEisa]{.trn}  
  Vowel on consonant before hamza: [a]{.trn}  
  Shortened vowel on hamza: [◌ْ]{.ar}  
  Precedence: [a]{.trn}  
  Seated:[أ]{.ar}
...
+ [لُؤَيّ]{.ar} [luEayy]{.trn}  
  Vowel on consonant before hamza: [a]{.trn}  
  Shortened vowel on hamza: [◌ْ]{.ar}  
  Precedence: [a]{.trn}  
  Seated:[أ]{.ar}

+ [شَنَآن]{.ar} [canaEAn]{.trn}  
  Vowel on consonant before hamza: [a]{.trn}  
  Shortened vowel on hamza: [◌ْ]{.ar}  
  Precedence: [a]{.trn}  
  Seated:[أ]{.ar}

+ [سَأَلَ]{.ar} [saEala]{.trn}  
  Vowel on consonant before hamza: [a]{.trn}  
  Shortened vowel on hamza: [◌ْ]{.ar}  
  Precedence: [a]{.trn}  
  Seated:[أ]{.ar}
...
+ [رَأَّسَ]{.ar} [raEEasa]{.trn}
  Vowel on consonant before hamza: [a]{.trn}
  Shortened vowel on hamza: [◌ْ]{.ar}  
  Precedence: [a]{.trn}  
  Seated:[أ]{.ar}

+ [يُرَئِّسُ]{.ar} [yuraEEisu]{.trn}
  Vowel on consonant before hamza: [a]{.trn}
  Shortened vowel on hamza: [◌ْ]{.ar}  
  Precedence: [a]{.trn}  
  Seated:[أ]{.ar}

+ [رُئِّسَ]{.ar} [ruEEisa]{.trn}
  Vowel on consonant before hamza: [a]{.trn}
  Shortened vowel on hamza: [◌ْ]{.ar}  
  Precedence: [a]{.trn}  
  Seated:[أ]{.ar}

+ [تَفَؤُّل]{.ar} [tafaEEul]{.trn}
  Vowel on consonant before hamza: [a]{.trn}
  Shortened vowel on hamza: [◌ْ]{.ar}  
  Precedence: [a]{.trn}  
  Seated:[أ]{.ar}

+ [سَءَّال]{.ar} [saEEAl]{.trn}
  Vowel on consonant before hamza: [a]{.trn}
  Shortened vowel on hamza: [◌ْ]{.ar}  
  Precedence: [a]{.trn}  
  Seated:[أ]{.ar}

+ [لَءَّال]{.ar} [laEEAl]{.trn}.
  Vowel on consonant before hamza: [a]{.trn}
  Shortened vowel on hamza: [◌ْ]{.ar}  
  Precedence: [a]{.trn}  
  Seated:[أ]{.ar}
