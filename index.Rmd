...
2. If [hamzao]{.trn} occurs in the middle of a word:
   a. If there is a long vowel or diphthong before the [hamzao]{.trn}:
        i. If the [hamzao]{.trn} is after a long-[I]{.trn} vowel or [ay]{.trn} diphthong, then the [hamzao]{.trn} will be written unseated. (Note: if the [hamzao]{.trn} has a [fatHao]{.trn} and is not doubled and is followed by an [Ealif]{.trn} which is not part of a suffix, then the combination of unseated [hamzao]{.trn} and [Ealif]{.trn} is written as [آ]{.ar}.) Examples:  
