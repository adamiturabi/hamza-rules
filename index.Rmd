...
Consider the vowel on the syllable before the [hamzao]{.trn} and that on the [hamzao]{.trn} itself. Determine which of the two vowels is higher in precedence in the above table. The prevailing vowel's default seat will be the seat of the [hamzao]{.trn}.

This is the basic underlying principle although there are a few exceptions. We now give a comrehensive set of rules and many examples that should exemplify this principle and the exceptions.
